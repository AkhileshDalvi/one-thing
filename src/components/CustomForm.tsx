...
const CustomForm = ({ thing, handleInput, handleSubmit }: { thing: string, handleInput: React.FormEventHandler<HTMLInputElement>, handleSubmit: React.FormEventHandler<HTMLFormElement> }) => {
  return (
    <>
